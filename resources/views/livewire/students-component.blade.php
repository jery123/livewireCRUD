<div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="float: right;">
                             ...
                             <input wire:model="searchTerm" id="search" type="text" placeholder="{{__('Search...')}}" class="form-control">
                          
                        <button class="btn btn-sm btn-secondary" wire:click="importShow()">Importer</button>
                        <button class="btn btn-sm btn-info" wire:click="export()">Exporter</button>
                        <button class="btn btn-sm btn-primary"  data-toggle="modal" data-target="#addStudentModal">Add New Student</button>
                        </div>
                         </div>
                    <div class="card-body">
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="importStudentModal" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Import Student file</h5>
                ...
                <form wire:submit.prevent="importStudent">
                     ...
                     <!-- <input class="form-control form-control-lg" name="student_import"  type="file" />
                     <div class="col-9">
                                <button type="submit" class="btn btn-sm btn-primary">Import</button>
                         </div> -->
                         <div class="mb-4">
                             <label for="student_import" class="form-label">{{__('Select file')}}</label>
                             <input wire:model.defer="student_import" class="form-control @error('student_import') is-invalid @enderror" type="file" name="student_import" id="formFile" required="">
                             @error('student_import')
                             <div class="invalid-feedback">{{$message}}</div>
                             @enderror
                         </div>
                         <div class="d-flex justify-content-end">
                             <button class=" btn btn-primary btn-sm" type="submit" wire:click.prevent="importStudent" {{empty($student_import) ? "disabled" : '' }}>{{__('Import')}}</button>
                         </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <th>Student of {{ $student->user->name }} </th>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        ...
        window.addEventListener('show-import-student-modal', event =>{
